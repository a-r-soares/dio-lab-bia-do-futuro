...
Vejam o ALDO em ação. Quando o usuário pergunta "O que é o IGP-M? Como ele afeta o dia a dia de uma dona de casa?", o sistema vai nos bastidores, cruza a pergunta com os dados frescos da API e entrega uma resposta extremamente didática a respeito do IGP-M e informa a taxa exata atual.
